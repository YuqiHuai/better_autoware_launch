...
source "$WORKSPACE_ROOT/autoware/amd64.env"
if [ "$(uname -m)" = "aarch64" ]; then
    source "$WORKSPACE_ROOT/autoware/arm64.env"
fi
...
MAP_PATH=$WORKSPACE_ROOT/data/autoware_map
DATA_PATH=$WORKSPACE_ROOT/data/autoware_data
WORKSPACE_PATH=""
USER_ID=""
WORKSPACE=""
...
DEFAULT_LAUNCH_CMD="/bin/bash"

AUTOWARE_IMAGE_VERSION="20250207"
...
# Set image version
set_image_version() {
    IMAGE=$IMAGE-$AUTOWARE_IMAGE_VERSION
}
